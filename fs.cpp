...
int FS::mkdir(std::string dirpath)
{
    ...
    // Write the ".." and "." entries in the new directory block
...
{
    static uint8_t current_dir_data[BLOCK_SIZE];
